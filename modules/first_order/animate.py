...
def normalize_kp(kp_source, kp_driving, kp_driving_initial, adapt_movement_scale=False,
    ...
    if use_relative_movement:
        ...
        if use_relative_jacobian:
            #jacobian_diff = jt.nn.matmul(kp_driving['jacobian'], torch.inverse(kp_driving_initial['jacobian']))
            jacobian_diff = jt.nn.matmul(kp_driving['jacobian'], jt.linalg.inv(kp_driving_initial['jacobian']))
            kp_new['jacobian'] = jt.nn.matmul(jacobian_diff, kp_source['jacobian'])
